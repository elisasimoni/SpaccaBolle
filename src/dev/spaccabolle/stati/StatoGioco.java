...
public class StatoGioco extends Stato{
	...
	public StatoGioco(Handler handler) {
		...
		uiManager.addObject(new UIImageButton(40, 700, 200, 90, Assets.btn_save, new ClickListener(){
			public void onClick() {
				Stato.setState(handler.getGame().menuState);
			}
		}));
		uiManager.addObject(new UIImageButton(330, 700, 200, 90, Assets.btn_pause, new ClickListener() {
		...
		uiManager.addObject(new UIImageButton(600, 700, 200, 90, Assets.btn_exit_statoGioco, new ClickListener() {
			public void onClick() {
				System.exit(0);
			}
		}));
		System.out.println("Gioco :"+uiManager.getObjects());
	}
